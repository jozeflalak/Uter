...
/*add by jlspyaozhongkai@126.com*/
int dwarf_get_macro_data(Dwarf_Debug dbg, Dwarf_Small **dss_data, Dwarf_Unsigned *dss_size, Dwarf_Error *error)
{
	int res;
    ...
    *dss_data = dbg->de_debug_macro.dss_data;
    *dss_size = dbg->de_debug_macro.dss_size;
	return DW_DLV_OK;
}

int dwarf_get_line_data(Dwarf_Debug dbg, Dwarf_Small **dss_data, Dwarf_Unsigned *dss_size, Dwarf_Error *error)
{
	int res;
    ...
    *dss_data = dbg->de_debug_line.dss_data;
    *dss_size = dbg->de_debug_line.dss_size;
	return DW_DLV_OK;
}
